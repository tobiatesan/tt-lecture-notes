...
\begin{mdframed}
  ...
  \[
    ...
    \qquad
    \begin{prooftree}
      \Gamma \vdash \varphi \supset \psi \qquad \Gamma \vdash \varphi
      \justifies
      \Gamma \vdash \psi
    \end{prooftree}
  \]
...
We write $\Gamma \vdash M : A$ to express the judgement ``$M$ is a \emph{proof
  term} for the proposition $A$ under the hypotheses $\Gamma$''.
  ...
  \begin{mdframed}
    \[
      \begin{prooftree}
        ...
        \justifies
        \Gamma \vdash \tyj{\pair{M}{N}}{\varphi \wedge \psi}
      \end{prooftree}
      \qquad
      \begin{prooftree}
        \Gamma \vdash \tyj{M}{\varphi \wedge \psi}
        \justifies
    ...
    \[
      \begin{prooftree}
        ...
        \justifies
        \Gamma \vdash \tyj{\inleft{\psi}{M}}{\varphi \vee \psi}
      \end{prooftree}
      \qquad
      \begin{prooftree}
        \Gamma \vdash \tyj{M}{\psi}
        \justifies
        \Gamma \vdash \tyj{\inright{\varphi}{M}}{\varphi \vee \psi}
      \end{prooftree}
    \]
    \[
      \begin{prooftree}
        \Gamma \vdash \tyj{M}{\varphi \vee \psi}
        \qquad
        \Gamma, \tyj{x}{\varphi} \vdash \tyj{d_1(x)}{\phi}
        \qquad
        \Gamma, \tyj{x}{\psi} \vdash \tyj{d_2(x)}{\phi}
        \justifies
        \Gamma \vdash \tyj{\casedisj{M}{(x)d_1}{(x)d_2}}{\phi}
        \using{\orelimrule}
      \end{prooftree}
    \]
    \[
      ...
      \qquad
      \begin{prooftree}
        \Gamma \vdash \tyj{M}{\varphi \supset \psi}
        \qquad
        \Gamma \vdash \tyj{N}{\varphi}
        \justifies
        \Gamma \vdash \tyj{\ap{M}{N}}{\psi}
      \end{prooftree}
    \]
    \[
      \begin{prooftree}
