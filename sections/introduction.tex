...
equivalence relation $~$ over $X$, we can construct a set $(X,~)$ simply by
changing $=_X$ with $~$, leaving the element-forming rules untouched.
...
$X^*$ with an equivalence relation $~$ that identifies lists with the same
